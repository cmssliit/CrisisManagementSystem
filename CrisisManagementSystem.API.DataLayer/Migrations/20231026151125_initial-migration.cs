    ...
    public partial class initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "227085d2-bcd1-46ae-aa49-12682004d2e9", null, "Administrator", "ADMINISTRATOR" },
                    { "fbe838bf-a3ec-4fb1-b4b2-efe84c6bbcf3", null, "User", "User" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "", "Ceo", "ThomasRay" },
                    { 2, "", "Excecutive", "JhonDoe" },
                    { 3, "", "Receptionist", "JaneDoe" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "very exapansive", 0, "MainBuilding", "fire in office", 1 },
                    { 2, "very exapansive", 0, "Whole", "Flood in office", 1 },
                    { 3, "very exapansive", 0, "Whole", "CyberAttack", 1 }
                });
